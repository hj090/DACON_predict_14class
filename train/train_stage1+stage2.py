...
Original file is located at
    https://colab.research.google.com/drive/1OgZgjgKUVTY0R8ZwWsu1ifL3cxqhDYIs
"""
...
#2. LightGBM
clf = lgb.LGBMClassifier(n_estimators=400, num_leaves=60, min_child_samples=10, learning_rate=0.1,
...
tfidf_probs_train = best_clf.predict_proba(X_train_vec)   # 학습셋 확률 (가중치 튜닝용)
tfidf_probs_val = best_clf.predict_proba(X_val_vec)       # 검증셋 확률
...
for th in thresholds_to_try:
    ...
    stage1_results_th, stage2_ids_th, stage2_probs_th = route_by_confidence(
        ids=val_ids, tfidf_probs=tfidf_probs_val,
        rule_probs=rule_probs_val,

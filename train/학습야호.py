...
Original file is located at
    https://colab.research.google.com/drive/139Y5xBsv53UqOouiACh_hPSquAxwgXpV
"""
...
print(session_train_df["dominant_code_lang"].value_counts())
print(session_train_df["dominant_code_ratio"].describe())
print(session_train_df["n_code_langs"].describe())

# 원-핫 인코딩 (학습 데이터로 fit, 검증은 transform만)
CATEGORICAL_COLS = ["language_pref", "last_ci_status", "git_dirty", "user_tier", "dominant_code_lang"]
NUMERIC_COLS = ["turn_index", "budget_tokens_remaining_log", "loc_log", "n_open_files", "dominant_code_ratio", "n_code_langs"]
...
print(importance_df[importance_df["feature"].str.startswith((
    ...
    'num__turn_index', 'num__budget_tokens_remaining_log', 'num__loc_log' 'num__n_open_files', 'num__dominant_code_ratio', 'num__n_code_langs'))])
